 ...
 */
class LiveInteractionModel extends Model
{
	protected $tableName = 'sc_live_interaction';
	...
	/**
	 * [getCourseInteractions 获取课程的互动记录]
	 * @author   Devil
	 * @blog     http://gong.gg/
	 * @version  0.0.1
	 * @datetime 2016-12-01T21:51:08+0800
	 ...
	 * @return   array                   [结果]
	 */
	public function getCourseInteractions($course_id, $limit = 100)
	{
		if(empty($course_id))
		{
			return array();
		}
		return $this->where(array('course_id' => $course_id))
