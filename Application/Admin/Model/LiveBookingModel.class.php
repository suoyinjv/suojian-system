 ...
 */
class LiveBookingModel extends Model
{
	protected $tableName = 'sc_live_booking';
	...
	public function saveData($data = array())
	{
		...
		{
			$data['booking_time'] = is_numeric($data['booking_time']) ? $data['booking_time'] : strtotime($data['booking_time']);
		}
