...
<div class="content-right">
	<div class="content">
		<legend>
			<span class="fs-16">财务统计</span>
			<a href="<?php echo U('Admin/Finance/Income');?>" class="fr fs-14 m-t-5 am-icon-mail-reply"> <?php echo L('common_operation_back');?></a>
		</legend>
			...
			<div class="am-u-sm-3">
				<div class="am-panel am-panel-success am-radius">
					<div class="am-panel-bd am-text-center">
						<p class="am-text-xxl">¥<?php echo ($total_income); ?></p>
						<p class="am-text-default">总收入</p>
					</div>
				</div>
			</div>
			<div class="am-u-sm-3">
				<div class="am-panel am-panel-danger am-radius">
					<div class="am-panel-bd am-text-center">
						<p class="am-text-xxl">¥<?php echo ($total_expense); ?></p>
						<p class="am-text-default">总支出</p>
					</div>
				</div>
			</div>
			<div class="am-u-sm-3">
				<div class="am-panel am-panel-primary am-radius">
					<div class="am-panel-bd am-text-center">
						<p class="am-text-xxl">¥<?php echo ($total_profit); ?></p>
						<p class="am-text-default">净利润</p>
					</div>
				</div>
			</div>
			<div class="am-u-sm-3">
				<div class="am-panel am-panel-warning am-radius">
					<div class="am-panel-bd am-text-center">
						<p class="am-text-xxl">¥<?php echo ($month_income); ?></p>
						<p class="am-text-default">本月收入</p>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="am-panel am-panel-default am-radius m-t-15">
			<div class="am-panel-hd">收支趋势</div>
			<div class="am-panel-bd">
				<div id="financeChart" style="width: 100%; height: 300px;"></div>
			</div>
		</div>

		<!-- 明细表格 -->
		<div class="am-panel am-panel-default am-radius m-t-15">
			<div class="am-panel-hd">近期收支明细</div>
			<div class="am-panel-bd">
				<table class="am-table am-table-striped am-table-hover">
					...
					<tbody>
						<?php if(!empty($list)): if(is_array($list)): foreach($list as $key=>$v): ?><tr>
									...
									<td class="am-text-success">+¥<?php echo ($v["income"]); ?></td>
									<td class="am-text-danger">-¥<?php echo ($v["expense"]); ?></td>
									<td class="am-text-primary">¥<?php echo ($v["profit"]); ?></td>
								</tr><?php endforeach; endif; ?>
						<?php else: ?>
							<tr><td colspan="4" class="am-text-center"><?php echo L('common_not_data_tips');?></td></tr><?php endif; ?>
					</tbody>
				</table>
			</div>
		</div>
...
<script>
$(function(){
	var chart = echarts.init(document.getElementById('financeChart'));
	chart.setOption({
		...
		yAxis: {type: 'value'},
		series: [
			{name: '收入', type: 'line', data: <?php echo ($income_list); ?>},
			{name: '支出', type: 'line', data: <?php echo ($expense_list); ?>},
			{name: '利润', type: 'line', data: <?php echo ($profit_list); ?>}
		]
	});
});
</script>