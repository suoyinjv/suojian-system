...
<div class="content-right">
	<div class="content">
		...
		<div class="am-g m-t-15">
			...
			<div class="am-u-sm-3">
				<div class="am-panel am-panel-warning am-radius">
					<div class="am-panel-bd am-text-center">
						<p class="am-text-xxl"><?php echo ($inactive_students); ?></p>
						<p class="am-text-default">沉默学员</p>
					</div>
				</div>
			</div>
			<div class="am-u-sm-3">
				<div class="am-panel am-panel-secondary am-radius">
					<div class="am-panel-bd am-text-center">
						<p class="am-text-xxl"><?php echo ($avg_consumption); ?></p>
						<p class="am-text-default">人均消费</p>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="am-g m-t-15">
			<div class="am-u-sm-6">
				<div class="am-panel am-panel-default am-radius">
					<div class="am-panel-hd">学员状态分布</div>
		...
		<div class="am-panel am-panel-default am-radius m-t-15">
			<div class="am-panel-hd">班级分布</div>
			<div class="am-panel-bd">
				<table class="am-table am-table-striped am-table-hover">
					...
					<tbody>
						<?php if(!empty($class_list)): if(is_array($class_list)): foreach($class_list as $key=>$v): ?><tr>
...
$(function(){
	...
	statusChart.setOption({
		...
		series: [{type: 'pie', radius: '60%', data: <?php echo ($status_data); ?>}]
	});

	var ageChart = echarts.init(document.getElementById('ageChart'));
	ageChart.setOption({
		tooltip: {trigger: 'axis'},
		xAxis: {type: 'category', data: <?php echo ($age_range); ?>},
		yAxis: {type: 'value'},
		series: [{type: 'bar', data: <?php echo ($age_data); ?>}]
	});
});
</script>