        ...
        <div class="am-g am-margin-top am-padding-top-sm">
            <div class="am-u-sm-12">
                <div class="am-btn-toolbar am-fr">
                    <a href="/admin.php/Admin/Resource/upload" class="am-btn am-btn-primary am-radius">
            ...
            <div class="am-u-sm-12">
                <form method="get" class="am-form-inline am-margin-bottom">
                    <div class="am-form-group">
                        <input type="text" name="keyword" class="am-form-field" placeholder="资源名称" value="{:I('keyword')}">
                    </div>
                    <div class="am-form-group">
                ...
                <table class="am-table am-table-bordered am-table-striped am-table-hover">
                    ...
                    <tbody>
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td>
                                <i class="am-icon <?php if($vo[\"type\"] == 1): ?>am-icon-file-word-o<?php elseif($vo[\"type\"] == 2): ?>am-icon-file-image-o<?php elseif($vo[\"type\"] == 3): ?>am-icon-file-video-o<?php elseif($vo[\"type\"] == 4): ?>am-icon-file-audio-o<?php elseif($vo[\"type\"] == 5): ?>am-icon-file-archive-o<?php else: ?>am-icon-file-o<?php endif; ?>"></i> {$vo.name} </td> <td>{$vo.type_text}</td> <td>{$vo.size_text}</td> <td>{$vo.category}</td> <td>{$vo.create_time|date='Y-m-d H:i', <td> <?php if($vo['is_shared'] == 1): ?><span class="am-badge am-badge-success">已共享</span>
                                <?php else: ?>
                                    <span class="am-badge am-badge-default">私有</span><?php endif; ?>
                            </td>
                            <td>
                                <a href="/admin.php/Admin/Resource/save/id/{$vo.id}" class="am-btn am-btn-xs am-btn-primary am-radius"><i class="am-icon-edit"></i> 编辑</a>
                                <a href="/admin.php/Admin/Resource/share/id/{$vo.id}" class="am-btn am-btn-xs am-btn-warning am-radius"><i class="am-icon-share"></i> 分享</a>
                                <a href="javascript:;" onclick="deleteConfirm('/admin.php/Admin/Resource/delete/id/{$vo.id}')" class="am-btn am-btn-xs am-btn-danger am-radius"><i class="am-icon-trash"></i> 删除</a>
                            </td>
