  ...
  <div class="page">
    ...
    <el-card class="filter-card" shadow="never">
      <el-form :model="filters" layout="inline">
        <el-form-item label="关键词">
          <el-input v-model="filters.keyword" placeholder="角色名称" clearable style="width: 240px">
    ...
    <el-card class="table-card" shadow="never">
      <el-table :data="list" stripe v-loading="loading">
        ...
        <el-table-column label="角色名称" min-width="160" prop="role_name" />
        <el-table-column label="角色描述" min-width="200" prop="description" />
    ...
    <!-- Add/Edit Dialog -->
    <el-dialog v-model="showDialog" :title="isEdit ? '编辑角色' : '添加角色'" width="520px" :close-on-click-modal="false">
...
const form = reactive({ role_name: '', description: '' })
...
async function loadData() {
  ...
  try {
    ...
    const res = await axios.get(BASE + '/m/Admin/c/Api/a/roleList', { params })
    const data = res.data
...
async function handleSave() {
  ...
  try {
    ...
    params.append('role_name', form.role_name)
    ...
    const url = isEdit.value
      ? BASE + '/m/Admin/c/Api/a/roleUpdate'
      : BASE + '/m/Admin/c/Api/a/roleCreate'
...
function handleDelete(row) {
  ElMessageBox.confirm(`确定删除角色「${row.role_name}」吗？`, '确认删除', { type: 'warning' })
    .then(async () => {
      try {
        await axios.get(BASE + '/m/Admin/c/Api/a/roleDelete?id=' + row.id)
